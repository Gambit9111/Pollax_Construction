...
export default function Navbar({}: Props) {
  // * global reference to sidebar menu component
  const sideMenuRef = useRef<HTMLDivElement>(null);
  // * passed to NavbarSideMenuButton component
  function handleSideMenuOpen(): void {
    ...
    <>
      ...
      <header className="z-10 flex h-20 w-full border-b border-my-black bg-my-white text-my-black xl:hidden">
        ...
        <nav className="flex w-1/2 items-center justify-center gap-6">
          ...
          {/* menu logo */}
          <NavbarSideMenuButton handleSideMenuOpen={handleSideMenuOpen} />
        </nav>
      </header>
      {/* Desktop */}
